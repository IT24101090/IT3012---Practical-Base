...
class VisualGridHuntGame:
    ...
    def get_percept(self) -> dict:
        ...
        return {
            ...
            # Global State Keys required for Search Algorithms
...
if __name__ == "__main__":
    root = tk.Tk()
    # Step 1.3: Instantiate SearchAgent with active_algo set to 'AStar'
    search_agent = SearchAgent(active_algo='AStar')
